...
public static partial class EasingMethods
{
    ...
    ///     <para>
    ///         For this easing method, there is no "In" our "Out" variation - there is just one single method that you can
    ///         use on it's own.
    ///     </para>
    ///     <para>
    ///         This method is based off this css transition: cubic-bezier(.25,.1,.25,1). I translated the internals of the
    ///         cubic-bezier method and simplified them so that they work for this single method only.
    ///     </para>
