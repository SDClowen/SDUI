...
public static class ValueFactoryCreator
{
    ...
    public static ValueFactory<Tuple<T1, T2>> CreateTupleFactory<T1, T2>(ValueFactory<T1> t1Factory,
        ValueFactory<T2> t2Factory)
    {
        return (startValue, targetValue, progress) =>
        {
            return Tuple.Create(t1Factory(startValue.Item1, targetValue.Item1, progress),
                t2Factory(startValue.Item2, targetValue.Item2, progress));
        };
    }

    public static ValueFactory<Tuple<T1, T2, T3>> CreateTupleFactory<T1, T2, T3>(ValueFactory<T1> t1Factory,
        ValueFactory<T2> t2Factory, ValueFactory<T3> t3Factory)
    {
        return (startValue, targetValue, progress) =>
        {
            return Tuple.Create(t1Factory(startValue.Item1, targetValue.Item1, progress),
    ...
    public static ValueFactory<Tuple<T1, T2, T3, T4>> CreateTupleFactory<T1, T2, T3, T4>(ValueFactory<T1> t1Factory,
        ValueFactory<T2> t2Factory, ValueFactory<T3> t3Factory, ValueFactory<T4> t4Factory)
    {
        return (startValue, targetValue, progress) =>
        {
            return Tuple.Create(t1Factory(startValue.Item1, targetValue.Item1, progress),
    ...
    public static ValueFactory<Tuple<T1, T2, T3, T4, T5>> CreateTupleFactory<T1, T2, T3, T4, T5>(
        ValueFactory<T1> t1Factory, ValueFactory<T2> t2Factory, ValueFactory<T3> t3Factory, ValueFactory<T4> t4Factory,
    ...
    public static ValueFactory<Tuple<T1, T2, T3, T4, T5, T6>> CreateTupleFactory<T1, T2, T3, T4, T5, T6>(
        ValueFactory<T1> t1Factory, ValueFactory<T2> t2Factory, ValueFactory<T3> t3Factory, ValueFactory<T4> t4Factory,
        ValueFactory<T5> t5Factory, ValueFactory<T6> t6Factory)
    {
        return (startValue, targetValue, progress) =>
        {
            return Tuple.Create(t1Factory(startValue.Item1, targetValue.Item1, progress),
    ...
    public static ValueFactory<Tuple<T1, T2, T3, T4, T5, T6, T7>> CreateTupleFactory<T1, T2, T3, T4, T5, T6, T7>(
        ValueFactory<T1> t1Factory, ValueFactory<T2> t2Factory, ValueFactory<T3> t3Factory, ValueFactory<T4> t4Factory,
        ValueFactory<T5> t5Factory, ValueFactory<T6> t6Factory, ValueFactory<T7> t7Factory)
    {
        return (startValue, targetValue, progress) =>
        {
            return Tuple.Create(t1Factory(startValue.Item1, targetValue.Item1, progress),
