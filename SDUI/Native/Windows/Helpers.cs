...
public static class Helpers
{
    ...
    /// </value>
    public static bool VisualStylesEnabled { get; private set; } = true;
    ...
    public static bool UseImmersiveDarkMode(IntPtr handle, bool enabled)
    {
        if (IsTen || IsEleven)
        {
            ...
            uint useImmersiveDarkMode = (uint)(enabled ? 1 : 0);
    ...
    public static void ApplyBorderColor(IntPtr hWnd, SKColor color)
    {
        var pvAttribute = (uint)color;
