...
///     <para>
///         I'd like to citate http://easings.net/ here - they have a great explanation about what easing functions are
///         and why they are important for making an animation feel realistic:
///     </para>
///     <para>
///         "Easing functions specify the rate of change of a parameter over time. Objects in real life don’t just start
///         and stop instantly, and almost never move at a constant speed. When we open a drawer, we first move it quickly,
///         and slow it down as it comes out. Drop something on the floor, and it will first accelerate downwards, and then
///         bounce back up after hitting the floor."
///     </para>
...
///     <para>
///         They can be found at http://robertpenner.com/easing/ and they are distributed as open source under the BSD
///         License.
///     </para>
/// </remarks>
public static partial class EasingMethods
{
    ...
    /// <returns>
    ///     An easing method that uses the first specified easing method for the first half of the animation and the
    ///     second one for the second half of the animation.
    /// </returns>
    public static EasingMethod Chain(this EasingMethod first, EasingMethod second)
    {
        return progress => progress < 0.5 ? .5 * first(progress * 2) : .5 + .5 * second((progress - .5) * 2);
    }
