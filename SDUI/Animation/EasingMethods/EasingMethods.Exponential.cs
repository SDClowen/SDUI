...
public static partial class EasingMethods
{
    ...
    /// <summary>
    ///     <para>
    ///         A combination of the <see cref="EasingMethods.ExponentialEaseIn" /> and
    ///         <see cref="EasingMethods.ExponentialEaseOut" /> methods.
    ///     </para>
    ///     <para>
    ///         It accelerates from approximately 0 to a velocity of approximately 7 (log 1024) and then decelerates back to
    ///         a velocity of approximately 0.
    ///     </para>
    /// </summary>
    /// <param name="progress">The time progress of the animation.</param>
    /// <returns>The value progress of the animation.</returns>
