...
public static partial class EasingMethods
{
    public static partial class Extended
    {
        ...
        private static readonly EasingMethod backEaseInOut = Chain(BackEaseIn, BackEaseOut);
        ...
        {
            return progress <= 0 ? 0 :
                progress >= 1 ? 1 : Math.Pow(progress - 1, 2) * ((back + 1) * (progress - 1) + back) + 1;
        }

        /// <summary>
        ///     <para>
        ///         A combination of the <see cref="EasingMethods.Extended.BackEaseIn" /> and
        ///         <see cref="EasingMethods.Extended.BackEaseOut" /> methods.
        ///     </para>
        ///     <para>
