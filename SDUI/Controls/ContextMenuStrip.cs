...
public class ContextMenuStrip : MenuStrip
{
    ...
    private readonly AnimationEngine _fadeInAnimation;
    private readonly Dictionary<MenuItem, AnimationEngine> _itemHoverAnims = new();
    ...
    public ContextMenuStrip()
    {
        ...
        _fadeInAnimation = new AnimationEngine
        {
            Increment = 0.30,
    ...
    private AnimationEngine EnsureItemHoverAnim(MenuItem item)
    {
        if (!_itemHoverAnims.TryGetValue(item, out var engine))
        {
            engine = new AnimationEngine { Increment = 0.25, AnimationType = AnimationType.EaseOut, Singular = true, InterruptAnimation = true };
