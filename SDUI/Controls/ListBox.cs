...
public class ListBox : UIElementBase
{
    ...
    public void EnsureVisible(int index)
    {
        ...
        var visibleItems =
            (Height - Padding.Vertical - (_horizontalScrollBar.Visible ? _horizontalScrollBar.Height : 0)) / ItemHeight;
    ...
    public override void OnPaint(SKPaintSurfaceEventArgs e)
    {
        ...
        for (var i = _topIndex; i < Math.Min(_items.Count, _topIndex + visibleItems + 1); i++)
        {
    ...
    internal override void OnMouseWheel(MouseEventArgs e)
    {
        ...
        var delta = e.Delta / 120 * scrollLines;
